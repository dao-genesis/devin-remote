...
|---|---|---|---|---|
| **dao-one** | `2.28.9` | `dao.dao-one` | 最终主交付：dao-vsix 二合一本源基座 + Proxy Pro 三面板子模块（折入 Devin Cloud 全功能面板），其余与 dao-vsix 完全一致。 | [Release](https://github.com/dao-genesis/devin-remote/releases/tag/dao-one-v2.28.9) · [⬇ VSIX](https://github.com/dao-genesis/devin-remote/releases/download/dao-one-v2.28.9/dao-one-2.28.9.vsix) |
...
| **dao-proxy-pro** | `9.9.359` | `dao-agi.dao-proxy-pro` | 底层提示词隔离替换 + 外接第三方模型路由。三面板：本源观照 / 渠道配置 / 模型路由。 | [Release](https://github.com/dao-genesis/devin-remote/releases/tag/dao-proxy-pro-v9.9.359) · [⬇ VSIX](https://github.com/dao-genesis/devin-remote/releases/download/dao-proxy-pro-v9.9.359/dao-proxy-pro-9.9.359.vsix) |
