...
| **dao-vsix** | `3.8.0` | `dao.dao-vsix` | 本源基座：rt-flow 切号视图 + Devin Cloud 全功能面板 + 本地 HTTP API（含多账号反向注入）。可单独安装。 | [Release](https://github.com/zhouyoukang1234-spec/devin-remote/releases/tag/dao-vsix-v3.8.0) · [⬇ VSIX](https://github.com/zhouyoukang1234-spec/devin-remote/releases/download/dao-vsix-v3.8.0/dao-vsix-3.8.0.vsix) |
...
| rt-flow-app | ✅ S23 Ultra 实测 | v0.14.3 · 七合一(切号+穿透+多实例+浏览器自动化+手机操控+系统级接管+渐进式文档) · browse* 19 + phone* 29 RPCs(含无障碍手势/读屏/截图) + IPC 桥 + 安全开关 + 本地 gradlew 编译验证 |
