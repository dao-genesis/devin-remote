...
| **dao-vsix** | `3.5.0` | `dao.dao-vsix` | 本源基座：rt-flow 切号视图 + Devin Cloud 全功能面板 + 本地 HTTP API（含多账号反向注入）。可单独安装。 | [Release](https://github.com/zhouyoukang1234-spec/devin-remote/releases/tag/dao-vsix-v3.5.0) · [⬇ VSIX](https://github.com/zhouyoukang1234-spec/devin-remote/releases/download/dao-vsix-v3.5.0/dao-vsix-3.5.0.vsix) |
| **rt-flow** | `4.9.0` | `devaid.rt-flow` | Devin Cloud 接入本体：对话备份 / 全量快照 / 一键回归本源 wipe / 对话额度上限。 | [Release](https://github.com/zhouyoukang1234-spec/devin-remote/releases/tag/rt-flow-v4.9.0) · [⬇ VSIX](https://github.com/zhouyoukang1234-spec/devin-remote/releases/download/rt-flow-v4.9.0/rt-flow-4.9.0.vsix) |
...
| rt-flow-app | ✅ S23 Ultra 实测 | v0.14.2 · 六合一(切号+穿透+多实例+浏览器自动化+手机操控+渐进式文档) · browse* 19 RPCs + phone* 19 RPCs(含联系人/短信/通话) + IPC 桥 + 安全开关 + getCloudMd/getLocalMd |
