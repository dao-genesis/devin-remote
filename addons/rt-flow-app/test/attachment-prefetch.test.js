...
ok(/installMediaRetry\(v\); installAttachmentPrefetch\(v\); installComposerUpload\(v\); installEnvModeBadge\(v, tab\.acctEmail\); harvestPageAuth/.test(main), "SPA 路由后重装 (doUpdateVisitedHistory)");
